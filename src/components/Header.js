...
const Header = (props) => {
    return <div className="flex flex-row">
        <div className="hexagon hexagon1">
            <div className="hexagon-in1">
                <div className="text-center hexagon-in2">
                    <span className="relative left-4 top-1 text-9xl text-black">Q</span>
                    <span className='relative right-4 top-1 text-9xl text-shadow-lg text-black'>G</span>
                </div>
            </div>
        </div>
        <div className="basis-1/2 trademark">
            <div className="relative top-2">Quest Giver Games, LTD Presents</div>
        ...
        <nav className="basis-1/2 flex flex-row cursor-pointer">
